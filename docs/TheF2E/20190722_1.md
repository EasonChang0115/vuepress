...
image: https://i.imgur.com/uUAYyOU.png
meta:
  - name: og:url
    content: https://easonchang0115.github.io/articles/javascript/20190722_1.html
  - name: og:title
...
2. [Vue drag-and-drop](https://github.com/SortableJS/Vue.Draggable): 原則上，不是很想用套件，時間也不允許我自己慢慢來，下班時間真的不多。所以就直接用這個很多顆星星的拖曳套件囉，基本上都有符合我的需求，也順便練習看文件弄弄看別人的套件。
