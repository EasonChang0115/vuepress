...
description: 越來越多人透過網站或是行動裝置了解世界了，我想要透過與使用者更多的互動，透過有趣的小操作或介面動畫，讓網頁不在是資料呈現的媒介而已，可以透過更好的效能，好玩的動畫呈現給使用者，讓網站變成一個藝術、一個透過作品說故事的地方。P5.js 把許多繁瑣的 canvas 操作隱藏起來，透過 API 文件，可以很輕鬆的在畫布上創造作品。希望透過吳哲宇老師的課程，我能在網頁的世界探索更多的可能。
...
meta:
  - name: og:url
    content: https://easonchang0115.github.io/blogs/theF2E/2021/20210530_1.html
  - name: og:title
    content: 我的第一個 P5.js 入門
  - name: og:description
    content:  越來越多人透過網站或是行動裝置了解世界了，我想要透過與使用者更多的互動，透過有趣的小操作或介面動畫，讓網頁不在是資料呈現的媒介而已，可以透過更好的效能，好玩的動畫呈現給使用者，讓網站變成一個藝術、一個透過作品說故事的地方。P5.js 把許多繁瑣的 canvas 操作隱藏起來，透過 API 文件，可以很輕鬆的在畫布上創造作品。希望透過吳哲宇老師的課程，我能在網頁的世界探索更多的可能。
  - name: og:image
...
越來越多人透過網站或是行動裝置了解世界了，我想要透過與使用者更多的互動，透過有趣的小操作或介面動畫，讓網頁不在是資料呈現的媒介而已，可以透過更好的效能，好玩的動畫呈現給使用者，讓網站變成一個藝術、一個透過作品說故事的地方。P5.js 把許多繁瑣的 canvas 操作隱藏起來，透過 API 文件，可以很輕鬆的在畫布上創造作品。希望透過吳哲宇老師的課程，我能在網頁的世界探索更多的可能。
