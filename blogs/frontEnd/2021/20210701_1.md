...
自從上一間新創寫 React 之後，雖然工作上較多都用 Vue，但是私底下還是比較喜歡 React 的特性與寫法，趁最近在看 React v18 的新特性。先來複習一下 Function(Hooks) 與 Class Component 的區別吧。
...
首先先來談談 Class component，其實如果元件的操作狀態複雜，還是建議使用 Class component 開發，畢竟狀態上的管理比較容易，且生命週期完整，各個鉤子涵數在實際開發上都會用到。
...
4. [React Class-based vs Functional Component
   從特性淺談兩種寫法之異同](https://linyencheng.github.io/2020/02/02/react-component-class-based-vs-functional/)
5. [How Are Function Components Different from Classes?
