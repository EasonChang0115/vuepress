<template>
  <div class="home-blog">
    <div class="hero" :style="{ ...heroStyle }">
      <div class="myImage" :style="{ ...bgImageStyle }"></div>
      <div>
        <ModuleTransition>
          <img
            class="hero-img"
...
import { ModuleTransition, RecoIcon } from '../plugins/core/lib/components'
  ...
  computed: {
    ...
    bgImageStyle () {
      const initBgImageStyle = {
        ...
        overflow: 'hidden',
        background: `
          url(${this.$frontmatter.bgImage ? this.$withBase(this.$frontmatter.bgImage) : require('../images/bg.svg')}) center/cover no-repeat
        `
      }
      const {
        bgImageStyle
